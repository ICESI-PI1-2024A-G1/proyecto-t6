...
class EventRequestTestCase(TestCase):
    ...
    def test_asignacion_profesor(self):
        solicitud = EventRequest.objects.create(usuario=self.user, lugar='Kioto', fecha_inicio='2024-04-10',
                                                fecha_fin='2024-04-15', presupuesto=2000, alimentacion='No incluida', transporte='Tren')
        solicitud.profesor = 'Miguel Caicedo'
        solicitud.save()
