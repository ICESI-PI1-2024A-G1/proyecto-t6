...
class LiveServerTestCase(LiveServerTestCase):
    ...
    def testRequest_correct(self):
        ...
        profesor = driver.find_element(By.NAME, "profesor")
    ...
    def testEventManager_aprove(self):
        driver = self.scrap()
        driver.get('http://127.0.0.1:8000/')
        assert "Icesi Sistema Freya" in driver.title
        btn = driver.find_element(
        ...
        gbtn = driver.find_element(By.XPATH, '//*[@id="solicitudes"]/li[1]/a')
        gbtn.click()

        estado = driver.find_element(By.NAME, "estado_solicitud")
